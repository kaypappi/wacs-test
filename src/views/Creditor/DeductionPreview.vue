    ...
    >
      <b-tab title="Validated Records" active>
        <b-skeleton-wrapper :loading="fetchingBatchItem">
          ...
          <BatchSchedulePreviewTable :previewItem="getValidatedItems" />
          <Pagination
      ...
      <b-tab title="Failed Records">
         <b-skeleton-wrapper :loading="fetchingBatchItem">
          ...
          <BatchSchedulePreviewTable :previewItem="getFailedItems" />
          <Pagination
          :total="getFailedItems.total"
          :currentPage="getFailedItems.current_page"
          :lastPage="getFailedItems.last_page"
          :from="getFailedItems.from"
          :to="getFailedItems.to"
        />
        </b-skeleton-wrapper>
      </b-tab>
    </b-tabs>
...
export default {
  ...
  computed: {
    ...
    getValidatedItems() {
      return this.$store.state.CreditorDeduction.validated;
    },
    getFailedItems() {
