...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                if(this.edittingUser || this.changingUserRole) {
                    this.$store.dispatch('AdminUser/editAdmin', {userData:{...this.addUser,userId: this.targetUserId},userType:'creditors'});
                } else{
                    this.$store.dispatch('AdminUser/createAdmin', {userData:this.addUser,userType:'creditors'});
                }
            },
            compareDataOnEdit() {
        ...
        computed: {
            ...
            paginationData() {
                console.log(this.$store.state.AdminUser.paginationData)
